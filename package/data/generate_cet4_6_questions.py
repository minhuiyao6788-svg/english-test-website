...
def generate_cet4_6_questions():
    """生成大学英语四六级测试题库"""
    
    questions = []
    
    # ==================== 词汇题 (基础版15题 + 完整版15题 = 30题) ====================
...
def create_cet4_6_questionnaire():
    """创建完整的四六级题库JSON文件"""
    
    # 生成题目
    questions = generate_cet4_6_questions()
...
if __name__ == "__main__":
    # 生成题库
    questionnaire = create_cet4_6_questionnaire()
