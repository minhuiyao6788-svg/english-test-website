...
def generate_150_cet4_6_questions():
    """生成完整的150题大学英语四六级测试题库"""
...
def create_150_cet4_6_questionnaire():
    """创建150题四六级题库JSON文件"""
    
    # 生成题目
    questions = generate_150_cet4_6_questions()
...
if __name__ == "__main__":
    # 生成题库
    questionnaire = create_150_cet4_6_questionnaire()
